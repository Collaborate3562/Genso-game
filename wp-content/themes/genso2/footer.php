	<footer id="footer">
		<div class="part1">
			<a href="" target="_blank">
				<img src="<?php echo get_template_directory_uri()?>/assets/images/logo_footer_en.png" alt="">
			</a>
		</div>
		<div class="part2">
			<a href="https://genso.game/wp-content/uploads/pdf/privacypolicy.pdf">Privacy Policy</a>&nbsp;｜&nbsp;<a href="<?php echo home_url()?>/faq">FAQ</a>&nbsp;｜&nbsp;<a href="<?php echo home_url()?>/contact">Contact Us</a>
		</div>
		<div class="part3">
